...
{
    public class AssetPackSyncResourceProvider : IResourceProviderModule
    {
        ...
        {
            Debug.LogFormat("[{0}.{1}] assetPackName={2}", nameof(AssetPackSyncResourceProvider), nameof(BeginOperation), assetPackName);
